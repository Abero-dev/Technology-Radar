        ...
        <footer className="bg-slate-600 text-white text-center py-8 px-0 w-full flex justify-center">
            <div className="flex flex-col items-center gap-5">
                <section className="social-container">
                    <NavLink to='https://www.facebook.com/vertexuci' target="blank" className="social-logo-container w-16 h-16 bg-white flex items-center justify-center overflow-hidden rounded-full hover:bg-amber-500 hover:invert transition-all duration-300">
                        <img src="/facebook_logo.png" alt="facebook_logo" className="img_social_logo w-10 h-10 rounded-lg" />
                    </NavLink>
                    <NavLink to='https://t.me/vertexti' target="blank" className="social-logo-container w-16 h-16 bg-white flex items-center justify-center overflow-hidden rounded-full hover:bg-orange-600 hover:invert transition-all duration-300">
                        <img src="/telegram_logo.png" alt="telegram_logo" className="img_social_logo w-10 h-10 rounded-lg" />
                    </NavLink>
                    <NavLink to='https://x.com/VertexUCI' target="blank" className="social-logo-container w-16 h-16 bg-white flex items-center justify-center overflow-hidden rounded-full hover:bg-white hover:invert transition-all duration-300">
